...
PLY_Use_Stop_Music      equ 0
PLY_Remove_Jump_Table   equ 1
...
PLY_Track1_NoNewPitch
    ...
    ld a,e
PLY_Transposition1 
    add 0       ;Transpose Note according to the Transposition in the Linker.
...
;******************************************
    ...
    ex af,af'
    add a           ;Mix Reg7 from Track2 with Track3, making room first.
    or ixl
    rla
    ex af,af'
...
PLY_PS_SD_Shift jr $+2
    ...
    inc hl
    exx
    add l                       ;Slow. Can be optimised ? Probably never used anyway.....
    ld l,a
    exx
    ld a,(hl)
    inc hl
...
PLY_PS_CalculateFrequency
    ...
    inc hl
    exx
    add e                       ;If Pitch found, add it directly to the TrackPitch.
    ld e,a
    exx
    ld a,(hl)
    inc hl
